...
| Any allocation, levy or disbursement figure | There is no allocator at v0. Those row types are refused **by name**, because publishing one would publish a figure that nothing computed | later |
